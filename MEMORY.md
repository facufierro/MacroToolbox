...
## Structure
- [src/App.tsx](src/App.tsx) — main UI: profiles, hotkey binding recorder (`toAhkKey` uses `e.code` for physical keys; AltGr's synthetic LCtrl is dropped so it records as plain ralt), settings.
